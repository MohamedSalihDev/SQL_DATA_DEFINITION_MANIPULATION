...
--Retrieve records from the companies table
...
VALUES	(6, 'Israel', 'Hawkins', 'hawkins@yahoo.com', 2, 'M' ),
		(7, 'Sharon', 'Metz', 'gracemt21@yahoo.com', 11, 'F');

SELECT * FROM customers_dup;

--Rename the sales_dup table into sales_data
...
ALTER TABLE items
RENAME COLUMN unit_price_usd TO item_price;
...
--Update the first_name of the 6th record of the table
...
-- ALTER the companies table to add a UNIQUE KEY constraint
-- to the headquarters_phone_number field.

ALTER TABLE companies
ADD CONSTRAINT com_dup_UK UNIQUE (headquarters_phone_number);
...
ALTER COLUMN headquarters_phone_number SET NOT NULL;
